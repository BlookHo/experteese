...
{name: 'P.-A. Renoir, Бал в Мулен де ла Галетт', file: 'Ball_Renour.jpg', theme_id: 1},
{name: 'P. Picasso, Фабрика', file: 'Picasso Fabrique.jpg', theme_id: 2},
{name: 'H. Matiss, Танец', file: 'dance_mattis2.jpg', theme_id: 3},
{name: 'радуга', file: 'raduga5обрез.jpg', theme_id: 6},
{name: 'Кандинский В.В., Жёлтое-красное-синее', file: 'Кандинский_ж.к.г_авапг.jpg', theme_id: 4},
{name: 'A. Raynaud, Ночь', file: 'Рейно_Ночь_класс.jpg', theme_id: 6},
...
{name: "Какое из произведений художника О.Ренуара наилучшим образом характеризует его творчество?"},      # 1
{name: "Какое из произведений художника П.Пикассо наилучшим образом характеризует его творчество?"},      # 2
{name: "Какое из произведений художника А.Матисса наилучшим образом характеризует его творчество?"},      # 3
{name: "Какое из произведений художника В.Кандинского наилучшим образом характеризует его творчество?"},  # 4
{name: "Какое из произведений художника В.ван Гога наилучшим образом характеризует его творчество?"},     # 5
{name: "Какое из изображений является наиболее гармоничным по вашему восприятию?"}                        # 6
